...
public class MovimientosPlaya {
	...
	public MovimientosPlaya(Integer id, int idPuestoDePlaya, int idVehiculo, LocalDateTime fechaHoraIngreso,
			int idUsuarioIngreso, LocalDateTime fechaHoraEgreso, Integer idUsuarioEgreso, int codigoBarraIn,
			Integer codigoBarraOut) {
		this.id = id;
