...
public class DescuentosPorHoraManager implements IDescuentosPorHoraManager {
	...
	public DescuentosPorHoraManager(IGenericRepository<DescuentosPorHora, Integer> oRepositorio, Connection connection) {
        this.repositorio = oRepositorio;
        this.connection = connection;
    }
	
	public void guardarDescuentosPorHora(DescuentoPorHoraDTO descuentoPorHoraDTO) {
		DescuentosPorHora descuentosPorHora = new DescuentosPorHora(null, descuentoPorHoraDTO.getCantidadDias(), descuentoPorHoraDTO.getPorcentajeDescuento());
    ...
    public DescuentoPorHoraDTO obtenerDescuentoPorId(Integer id)
    {
        ...
        if (descuentosPorHora != null) {
            return new DescuentoPorHoraDTO(descuentosPorHora.getId(), descuentosPorHora.getCantidadDias(), descuentosPorHora.getPorcentajeDescuento());
        } else {
    ...
    public void actualizarDescuentoPorHora(DescuentoPorHoraDTO descuentoPorHoraDTO) {
		DescuentosPorHora descuentosPorHora = new DescuentosPorHora(descuentoPorHoraDTO.getId(), descuentoPorHoraDTO.getCantidadDias(), descuentoPorHoraDTO.getPorcentajeDescuento());
	 ...
	 * */
	public Boolean validarExistenciaDeDescuento(int cantidadHoras) {
	    String sql = "SELECT id, cantidadDias, porcentajeDescuento " +
	                 "FROM DescuentosPorHora " +
	                 "WHERE cantidadDias = ? ";
